...
class Listing(models.Model):
    ...
    sale_type=models.CharField(max_length=50,choices=SALE_TYPE,default=SALE_TYPE[0])
    price=models.IntegerField()
    bedrooms=models.IntegerField()
    bathrooms=models.DecimalField(max_digits=2,decimal_places=1)
    home_type=models.CharField(max_length=50,choices=HOME_TYPE,default=HOME_TYPE[0])
